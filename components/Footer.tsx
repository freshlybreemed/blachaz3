...
const Footer: React.FC = () => {
  return (
    <footer className='pa4 pa5-l black bt b--black-10'>
      <section className='cf mb5'>
        <div className='mb4 mb0-ns fl w-100 w-50-l'>
          ...
          <form
            action='https://blachaz3.us19.list-manage.com/subscribe/post?u=3fcb495430e50962a396c4c6e&amp;id=37425b7238'
            method='post'>
            <input
      ...
      <div className='dt dt--fixed w-100'>
        <div className='dn dtc-ns v-mid'>
          <p className='f7 black-70 dib pr3 mb3'>
            © {getCurrentYear()} Blachaz3· All rights reserved.
          </p>
        </div>
