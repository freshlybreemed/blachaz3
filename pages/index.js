  ...
  <div>
    ...
    <article class="helvetica pb5">
      <header class="vh-100 bg-light-pink dt w-100">
        <div 
          style={{background:'url(/static/img/DSC00008.jpg) no-repeat center;'}} 
          ...
          <h2 class="f4 f2-ns  measure white lh-title fw7">Consolidating Philanthropy & Social Justice With Fashion, Art,
                Music to change the world in a positive way.</h2>
          <a
            ...
            >
              <svg 
              fill="currentColor"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M10 9.333l5.333 2.662-5.333 2.672v-5.334zm14-9.333v24h-24v-24h24zm-4 12c-.02-4.123-.323-5.7-2.923-5.877-2.403-.164-7.754-.163-10.153 0-2.598.177-2.904 1.747-2.924 5.877.02 4.123.323 5.7 2.923 5.877 2.399.163 7.75.164 10.153 0 2.598-.177 2.904-1.747 2.924-5.877z"/></svg>
            </a>
          ...
          <div class="cf dt-l w-100">
            ...
            <div class="dtc-l v-mid ph3 f4-m f4-l measure-l">
              <p class="measure fw6 pv4-l center">
                Hazel, more commonly known as “Blachaz3” (pronounced Black Haze) is a Ghanaian-American creative Entrepreneur based in the United
                  States. Blachaz3 graduated from Fordham University with her
                  master’s in international social work with a focus in social
                  justice and leadership. </p> <p class="measure fw6 pv4-l center"> While in school, she focused on developing
                  her skills as a creative, public speaker, and business women so
                  that she could merge them with her overall career as a social
                  worker. As as result of this process, Blachaz3 created her own
                  social work based organization called <a href="#"className={`${styles.link}`}>
                  FISTS UP AFROS OUT</a>.</p> <p class="measure fw6 pv4-l center">  Her
                  aim is to unify our people globally through, community service,
                  education, programs, and creative arts.
              </p>
          </div>
        </div>
      </div>
