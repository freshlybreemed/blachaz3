    ...
    <Wrapper data={data}>
      <article className='helvetica pb5'>
        <header className='vh-100 dt w-100'>
          <div
            style={{
              background: 'url(/static/img/hazehome1.jpg) no-repeat center;',
            }}
            className='dtc v-mid cover ph3 ph4-m ph5-l'>
            <span className='f2 f-subheadline-l f-subheadline-ns  measure white lh-title fw9 bg-black-90 pa2  '>
              BlacHaz3
            </span>
            <h2 className='f5 f3-ns  measure white lh-title fw7 bg-black-90 pa2'>
              Art-Based Mental Health Practitioner, Visual & Conceptual Creative
              Director, Sustainable Fashion Designer, Brand Strategist , Digital
              Marketing Specialist , Sustainable Fashion Designer, Public
              Speaker.
            </h2>
            <a
              href='https://www.facebook.com/Blachaz3'
              className='link dim dib mr3 white-70 black'
            ...
            <a
              className='link hover-silver white-70 dib h2 w2 mr3 black'
          ...
          <div className='f4 f3-m lh-copy'>
            <div className='cf dt-l w-100'>
              <div className='dtc-l v-mid mw6 pa2 pr3-l db center'>
                <img
                  className='db w-100 '
                  src='/static/img/IMG_5753.JPG'
                  alt=''
                />
              </div>
              <div className='dtc-l v-mid ph3 f4-m f4-l measure-l'>
                <p className='measure fw6 center'>
                  Hazel Blachaz, more commonly known online as “Blachaz3”
                  (pronounced Black Haze) is a Ghanaian-American creative
                  entrepreneur currently based in the States. Hazel graduated
                  from Fordham University with her Master’s in International
                  Social Work with a concentration in Social Justice and
                  Leadership.
                </p>{' '}
                <p className='measure fw6 center'>
                  During her schooling, she focused on developing her skills as
                  an overall art-based mental health practitioner, visual and
                  conceptual creative director, sustainable fashion designer and
                  stylist, public speaker, businesswoman and global
                  philanthropist with the purpose of merging these skills with
                  her overall career. As a result of this process, Hazel created
                  an organization called{' '}
                  <a href='/fists-up-afros-out' className={`${styles.link}`}>
                    FISTS UP AFROS OUT
                  </a>{' '}
                  where she focuses to unify underrepresented populations
                  through programs, art, and community service
                </p>{' '}
                <p className='measure fw6 center'> </p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className='pa3 pa4-m pa5-l'>
          <div
            ...
            <img
              ...
              src='/static/img/Afro-LogoDesign.png'
            />
          </div>
          <div
            className='link  black-80 hover-silver dib mv1  mh3 tc'
          ...
          <div
            className='link black-80 hover-silver dib mv1  mh3 tc'
            title='Facebook'>
            <img className='dib h2' src='/static/img/bbc.png' />
          </div>
          <div
            className='link black-80 hover-silver dib mv1  mh3 tc'
            title='Facebook'>
            <img className='dib h2' src='/static/img/forbes.png' />
          </div>
          <div
            className='link black-80 hover-silver dib mv1  mh3 tc'
            title='Facebook'>
            <img className='dib h2' src='/static/img/cbs.png' />
          </div>
          <div
            className='link black-80 hover-silver dib mv1  mh3 tc'
            title='Facebook'>
